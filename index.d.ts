...
export const loadGapiInsideDOM: () => Promise<gapi.auth2.GoogleAuth>;

export const gapiComplete: any;

// Type definitions from: https://github.com/DefinitelyTyped/DefinitelyTyped/blob/master/types/gapi.auth2/index.d.ts
...
declare namespace gapi.auth2 {
  ...
  class GoogleAuth {
     ...
     */
    then(
      onInit: (googleAuth: GoogleAuth) => any,
